...
\input{Parts/Artem_Makogon}


\input{Parts/PipeDream.tex}


\input{Parts/tensor_parallelism}

\input{Parts/doc}

\input{Parts/Large_Scale_Distributed_Deep_Networks}
